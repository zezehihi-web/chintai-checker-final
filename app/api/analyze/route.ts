...
### 優先順位1：【仲介手数料の厳格判定】
**重要**: 仲介手数料は法律的に賃料の0.5ヶ月分（税別）＝0.55ヶ月分（税込）が原則です。これを超える場合は必ず削減可能として判定してください。

| 条件 | 判定 (status) | 適正価格 (price_fair) | 理由 (reason) |
| :--- | :--- | :--- | :--- |
| **賃料の1ヶ月分（税込）以上の場合** | **negotiable** | 賃料の0.55ヶ月分（税込） | "法律的に賃料の0.5ヶ月（税別）が原則です。1ヶ月分以上の場合、交渉により0.5ヶ月（税別）まで減額できる可能性が高いです。" |
| **賃料の0.6ヶ月分（税込）以上、1ヶ月分未満の場合** | **negotiable** | 賃料の0.55ヶ月分（税込） | "法律的に賃料の0.5ヶ月（税別）が原則です。交渉により0.5ヶ月（税別）まで減額できる可能性があります。" |
...
3. **仲介手数料の維持**: 仲介手数料は法律的に賃料の0.5ヶ月分（税別）が原則であり、それを超える場合、必ず「negotiable」（削減可能・赤）のままにしてください。要確認（黄）にしないでください。
          ...
          if (rent > 0) {
            ...
            if (brokerageDiscount > 100) {
              json.items[brokerageIndex] = {
                ...
                status: 'negotiable',
                reason: `法律的に賃料の0.5ヶ月（税別）が原則です。交渉により${brokerageFair.toLocaleString()}円まで減額できる可能性があります。`
              };
            ...
            if (brokerageOriginal >= 50000) {
              ...
              json.items[brokerageIndex] = {
                ...
                status: 'negotiable',
                reason: `仲介手数料が高額です。法律的に賃料の0.5ヶ月（税別）が原則のため、${estimatedFair.toLocaleString()}円程度まで減額交渉できる可能性があります。`
              };
